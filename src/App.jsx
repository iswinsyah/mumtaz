...
function App() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'home':
        return <HomeTab setActiveTab={setActiveTab} handleShareApp={handleShareApp} />;
                ...
                <div className="flex bg-gray-100 p-1 rounded-xl w-full">
                  ...
                  <button 
                    onClick={() => {
                      ...
                      // Meminta browser HP masuk ke Layar Penuh (menyembunyikan URL Bar)
                ...
                <div className="fixed inset-0 z-[200] bg-gray-900 overflow-y-auto flex justify-center p-2 sm:p-8 animate-in zoom-in-95 duration-300" dir="rtl">
                   <button 
                     onClick={() => {
                       ...
                       // Keluar dari Layar Penuh browser
  ...
  return (
    <div className="w-full h-[100dvh] lg:h-screen bg-gray-50 overflow-hidden relative font-sans flex flex-col lg:flex-row text-gray-800 select-none">
      ...
      <div className="flex-1 overflow-y-auto bg-gray-50 order-first lg:order-last flex justify-center w-full">
         <div className="w-full lg:max-w-4xl relative bg-white lg:shadow-sm lg:border-x border-gray-100 min-h-full">
           {renderTabContent()}
         </div>
      </div>
      ...
      <div className="lg:w-72 lg:h-full lg:flex-col lg:justify-start lg:pt-8 lg:border-r lg:border-t-0 h-[76px] bg-white/90 backdrop-blur-md border-t border-gray-100 flex justify-around items-center px-2 lg:px-5 pb-2 lg:pb-0 pt-2 lg:pt-8 relative z-50 order-last lg:order-first shrink-0 shadow-sm lg:shadow-none">
        ...
        <div className="hidden lg:flex items-center gap-3 mb-10 px-2 w-full">
           <img src="https://github.com/iswinsyah/mumtaz/blob/main/Logo.png?raw=true" alt="Logo Mumtaz App" className="w-11 h-11 rounded-xl shadow-sm object-cover border border-green-100 bg-white" />
           <div>
